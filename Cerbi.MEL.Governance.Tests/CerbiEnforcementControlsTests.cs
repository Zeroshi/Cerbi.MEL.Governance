...
namespace Cerbi.Tests
{
    public class CerbiEnforcementControlsTests
    {
        ...
        private static CerbiGovernanceLogger CreateLogger(CerbiGovernanceMELSettings settings, Mock<ILogger>? innerMock = null)
        {
            ...
            var validator = new Mock<RuntimeGovernanceValidator>(new Func<bool>(() => true), settings.Profile, new FileGovernanceSource("x.json", settings.Profile), Array.Empty<IRuntimeGovernancePlugin>()) { CallBase = true }.Object;
